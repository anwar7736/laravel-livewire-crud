            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" wire:submit.prevent="register" enctype="multipart/form-data">
                        ...
                        @isset($photo)
                           <div class="row mb-3">
                            <label for="" class="col-md-4 col-form-label text-md-end">{{ __('Preivew Image') }}</label>
                            <div class="col-md-6">
                                <img src="{{$photo->temporaryUrl()}}" alt="No Image Found" height="80" width="80">
                            </div>
                        </div>
                        @endisset
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button wire:loading.attr="disabled" wire:targer="photo" type="submit" class="btn btn-primary">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
